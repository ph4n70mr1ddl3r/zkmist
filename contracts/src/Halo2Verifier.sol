...
contract Halo2Verifier {
    ...
    uint256 internal constant FIRST_QUOTIENT_X_CPTR = 0x09c4;
    uint256 internal constant  LAST_QUOTIENT_X_CPTR = 0x0a44;
    ...
    uint256 internal constant       G1_SCALAR_MPTR = 0x1460;
    ...
    function verifyProof(
        ...
        assembly {
...

            {
                ...
                // Read evaluations
                for
                    { let proof_cptr_end := add(proof_cptr, 0x0c80) }
                    lt(proof_cptr, proof_cptr_end)
                    {}
                {
                ...
                extcodecopy(vk, VK_MPTR, 0x00, 0x0c20)
            ...
            // Compute quotient evavluation
            {
                ...
                let y := mload(Y_MPTR)
                {
                    let f_8 := calldataload(0x0de4)
                    let var0 := 0x2
                    let var1 := sub(r, f_8)
                    let var2 := addmod(var0, var1, r)
                    let var3 := mulmod(f_8, var2, r)
                    let a_16 := calldataload(0x0c84)
                    let a_17 := calldataload(0x0ca4)
                    let var4 := mulmod(a_16, a_17, r)
                    let a_18 := calldataload(0x0cc4)
                    let var5 := sub(r, a_18)
                ...
                {
                    let f_9 := calldataload(0x0e04)
                    let var0 := 0x2
                    let var1 := sub(r, f_9)
                    let var2 := addmod(var0, var1, r)
                    let var3 := mulmod(f_9, var2, r)
                    let a_16 := calldataload(0x0c84)
                    let f_0 := calldataload(0x0ce4)
                ...
                {
                    let f_10 := calldataload(0x0e24)
                    let var0 := 0x2
                    let var1 := sub(r, f_10)
                    let var2 := addmod(var0, var1, r)
                    let var3 := mulmod(f_10, var2, r)
                    let a_0 := calldataload(0x0a84)
                    let var4 := 0x1
                    let var5 := sub(r, a_0)
                    let var6 := addmod(var4, var5, r)
                    let var7 := mulmod(a_0, var6, r)
                ...
                }
                {
                    ...
                    let var3 := mulmod(f_10, var2, r)
                    let a_0 := calldataload(0x0a84)
                    let a_1 := calldataload(0x0aa4)
                    let var4 := mulmod(a_0, a_1, r)
                    let a_2 := calldataload(0x0ac4)
                    let var5 := sub(r, a_2)
                    let var6 := addmod(var4, var5, r)
                    let var7 := mulmod(var3, var6, r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), var7, r)
                ...
                }
                {
                    ...
                    let var3 := mulmod(f_12, var2, r)
                    let a_0 := calldataload(0x0a84)
                    let f_3 := calldataload(0x0d44)
                    let var4 := addmod(a_0, f_3, r)
                    let a_1 := calldataload(0x0aa4)
                    let var5 := sub(r, a_1)
                    let var6 := addmod(var4, var5, r)
                    let var7 := mulmod(var3, var6, r)
                ...
                }
                {
                    ...
                    let a_3 := calldataload(0x0ae4)
                    let var6 := sub(r, a_3)
                    let var7 := addmod(var5, var6, r)
                    let a_4 := calldataload(0x0b04)
                ...
                }
                {
                    ...
                    let eval := addmod(l_0, sub(r, mulmod(l_0, calldataload(0x11c4), r)), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let perm_z_last := calldataload(0x1584)
                    let eval := mulmod(mload(L_LAST_MPTR), addmod(mulmod(perm_z_last, perm_z_last, r), sub(r, perm_z_last), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1224), sub(r, calldataload(0x1204)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1284), sub(r, calldataload(0x1264)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x12e4), sub(r, calldataload(0x12c4)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1344), sub(r, calldataload(0x1324)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x13a4), sub(r, calldataload(0x1384)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1404), sub(r, calldataload(0x13e4)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1464), sub(r, calldataload(0x1444)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x14c4), sub(r, calldataload(0x14a4)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1524), sub(r, calldataload(0x1504)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let eval := mulmod(mload(L_0_MPTR), addmod(calldataload(0x1584), sub(r, calldataload(0x1564)), r), r)
                    quotient_eval_numer := addmod(mulmod(quotient_eval_numer, y, r), eval, r)
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x11e4)
                    let rhs := calldataload(0x11c4)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0a84), mulmod(beta, calldataload(0x0f24), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0aa4), mulmod(beta, calldataload(0x0f44), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1244)
                    let rhs := calldataload(0x1224)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0ac4), mulmod(beta, calldataload(0x0f64), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0ae4), mulmod(beta, calldataload(0x0f84), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x12a4)
                    let rhs := calldataload(0x1284)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0b04), mulmod(beta, calldataload(0x0fa4), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0b24), mulmod(beta, calldataload(0x0fc4), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1304)
                    let rhs := calldataload(0x12e4)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0b44), mulmod(beta, calldataload(0x0fe4), r), r), gamma, r), r)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0b64), mulmod(beta, calldataload(0x1004), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1364)
                    let rhs := calldataload(0x1344)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0b84), mulmod(beta, calldataload(0x1024), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x13c4)
                    let rhs := calldataload(0x13a4)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1424)
                    let rhs := calldataload(0x1404)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1484)
                    let rhs := calldataload(0x1464)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x14e4)
                    let rhs := calldataload(0x14c4)
                    lhs := mulmod(lhs, addmod(addmod(mload(INSTANCE_EVAL_MPTR), mulmod(beta, calldataload(0x1124), r), r), gamma, r), r)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x1544)
                    let rhs := calldataload(0x1524)
                ...
                }
                {
                    let gamma := mload(GAMMA_MPTR)
                    let beta := mload(BETA_MPTR)
                    let lhs := calldataload(0x15a4)
                    let rhs := calldataload(0x1584)
                    lhs := mulmod(lhs, addmod(addmod(calldataload(0x0d44), mulmod(beta, calldataload(0x11a4), r), r), gamma, r), r)
                ...
                }
                {
                    ...
                    let input
                    {
                        let a_12 := calldataload(0x0c04)
                        input := a_12
                    }
                    let table
                    {
                        let f_2 := calldataload(0x0d24)
                        table := f_2
                    }
                    let beta := mload(BETA_MPTR)
                    let gamma := mload(GAMMA_MPTR)
            ...
            // Compute pairing lhs and rhs
            {
                ...
                }
                {
                    ...
                    let r_eval
                    r_eval := mulmod(coeff, calldataload(0x0f04), r)
                ...
                }
                {
                    let zeta := mload(ZETA_MPTR)
                    let r_eval
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1564), r), r)
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x14c4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x14e4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x14a4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x1464), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x1484), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1444), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x1404), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x1424), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x13e4), r), r)
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x1344), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x1364), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1324), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x12e4), r), r)
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x1284), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x12a4), r), r)
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0x40), calldataload(0x1264), r), r)
                    ...
                    r_eval := addmod(r_eval, mulmod(mload(0x60), calldataload(0x11c4), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0x80), calldataload(0x11e4), r), r)
                ...
                }
                {
                    ...
                    r_eval := mulmod(r_eval, zeta, r)
                    r_eval := addmod(r_eval, mulmod(mload(0xa0), calldataload(0x1584), r), r)
                    r_eval := addmod(r_eval, mulmod(mload(0xc0), calldataload(0x15a4), r), r)
                ...
                }
                {
                    ...
                    mstore(0x00, calldataload(0x0984))
                    mstore(0x20, calldataload(0x09a4))
