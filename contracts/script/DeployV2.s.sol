...
///   forge script script/DeployV2.s.sol --rpc-url $BASE_SEPOLIA_RPC --broadcast
///
///   # Mainnet (Base):
...
///      cargo run --bin gen-verifier --features v2 -- --output contracts/src/Halo2Verifier.sol
...
contract DeployV2 is Script {
    ...
    function run() external {
        ...
        console.log("=== ZKMist V2 Deployment ===");
        ...
        // ── Step 3: Deploy ZKMTokenV2 ─────────────────────────────────
        console.log("");
        console.log("Step 3: Deploying ZKMTokenV2...");
        ...
        // ── Step 4: Deploy ZKMAirdropV2 ───────────────────────────────
        console.log("");
        console.log("Step 4: Deploying ZKMAirdropV2...");
        ...
        console.log("     forge verify-contract <address> ZKMTokenV2 --chain base");
        console.log("     forge verify-contract <address> ZKMAirdropV2 --chain base");
        console.log("  2. Update cli/src/constants.rs:");
        console.log("     AIRDROP_CONTRACT_V2 = \"%s\"", address(airdrop));
