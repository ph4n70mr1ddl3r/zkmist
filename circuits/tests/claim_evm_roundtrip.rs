...
fn test_claim_circuit_evm_roundtrip() {
    ...
    if let Some(p) = &emit_path {
        ...
        let banner = "/// @dev ⚠️ DEV-SRS WIRING-ONLY VERIFIER — generated against a toxic-waste\n\
...
///      trapdoor holder can forge. Regenerate with the production SRS before\n\
///      mainnet (`gen-roundtrip-fixture` + this emitter under the pinned SRS).\n\
///      Generated by circuits/tests/claim_evm_roundtrip.rs (ZKMIST_EMIT_VERIFIER).\n";
        ...
        eprintln!("[roundtrip] wrote dev-SRS verifier → {p}");
    }
